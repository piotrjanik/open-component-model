...
// implement the optional [OwnershipReferrerAttacher] capability (e.g. the
...
func (c *DefaultConstructor) attachOwnershipReferrer(ctx context.Context, resource *constructor.Resource, res *descriptor.Resource, component, version string) error {
	...
	attacher, ok := repo.(OwnershipReferrerAttacher)
	if !ok {
...
func addColocatedResourceLocalBlob(
	...
	uploaded, err := repo.AddLocalResource(ctx, component, version, descResource, data,
		repository.WithOwnershipReferrerCreation(resource.Options.OwnershipPolicy == constructor.OwnershipPolicyAlways))
	if err != nil {
